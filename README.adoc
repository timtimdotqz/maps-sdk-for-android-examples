...
* https://developer.tomtom.com/maps-sdk-android/geofencing-public-preview[Geofencing]
...
* https://developer.tomtom.com/maps-sdk-android/api-reference-1[Javadocs for Geofencing]
